...
const ArrayOfPeople = [
   {
      name:"Amal",
      age: 25,
      favoriteFoods :  ["Salade César", "Sushi","Spaghetti pesto","burrito"],
    },

    { 
      name:"Oumayma",
      age: 24,
      favoriteFoods :  ["Pâte", "Mlokhya", "burrito"],
    ...
    {       
      name:"Sirine",
      age: 25,
      favoriteFoods :  ["Escalope", "Spaghetti fruit de mer","burrito"],
...
// Person.findById({ "_id" :"60e5c5a5f14f21365c6d25b2"} ,
...
//     //   MongoDB and Mongoose - Delete Many Documents with model.remove()
  ...
  // Person.deleteMany({name:"Sirine"}, function (err,Found) {
  //   if (err) return console.log(err);
  //   else
